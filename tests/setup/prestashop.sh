...
php -l ${PS_ROOT}install-dev/index_cli.php
command php ${PS_ROOT}install-dev/index_cli.php -- --language=en --country=us --domain=${TEST_HOST} --base_uri=${TEST_BASE_DIR} --db_name=prestashop.test --db_create=1 --name=prestashop.test --password=123456789
